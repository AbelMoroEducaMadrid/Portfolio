...
export default function Links({ t }: LinksProps) {
  const links = [
    {
      name: "GitHub (" + t.personal + ")",
      url: "https://github.com/HarkonG",
      icon: Github,
    },
    {
      name: "GitHub (" + t.fp + ")",
      url: "https://github.com/AbelMoroEducaMadrid",
      icon: Github,
    },
    {
      name: "GitHub (" + t.universidad + ")",
      url: "https://github.com/AbelMoro",
      icon: Github,
    },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/abel-moro-paje-244605340",
      icon: Linkedin,
    },
    {
      name: "Europass",
      url: "https://europa.eu/europass/eportfolio/api/eprofile/shared-profile/abel-moro+paje/06574dac-3a18-442d-933d-cad7e713bf63?view=html",
      icon: FileText,
    },
  ];
